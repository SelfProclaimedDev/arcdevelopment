    ...
    return(
        <React.Fragment>
            <Grid container direction='column' className={classes.mainContainer}>
                    ...
                    <Grid container justify="flex-end" alignItems="center" direction='row'>
                        <Grid sm item className={classes.heroTextContainer}>
                            ...
                            <Grid container justify="center" className={classes.buttonContainer}>
                                ...
                                <Grid item>
                                    <Button component={Link} onClick={() => setValue(2)} to="/revolution" variant='outlined' className={classes.learnButtonHero}>
                ...
                <Grid item>{/*---Custom Software Development*/}
                ...
                <Grid item>{/*----iOS/Android App Dev----*/}
                    <Grid container direction='row' justify={matchesSM ? "center" : "flex-end"} className={classes.serviceContainer}>
                        <Grid item style={{ textAlign: matchesSM ? "center" : undefined}}>
                            ...
                            <Button component={Link} to="/mobileapps" onClick={() => {setValue(1); setSelectedIndex(1);}}  variant='outlined' className={classes.learnButton}>
                                <span style={{marginRight:10}}>Learn More</span>
                                <ButtonArrow height={10} width={10} fill={theme.palette.common.blue}/>
                            </Button>
                        </Grid>
                ...
                <Grid item>{/*----Websites Block----*/}
                    <Grid container direction='row' justify={matchesSM ? "center" : undefined} className={classes.serviceContainer}>
                        <Grid item style={{ marginLeft: matchesSM ? 0 : "5em",textAlign: matchesSM ? "center" : undefined}}>
                            ...
                            <Button component={Link} to="/websites" onClick={() => {setValue(1); setSelectedIndex(2);}} variant='outlined' className={classes.learnButton}>
                                <span style={{marginRight:10}}>Learn More</span>
                                <ButtonArrow height={10} width={10} fill={theme.palette.common.blue}/>
                            </Button>
                        </Grid>
                        ...
                        <Card className={classes.revolutionCard}>
                            <CardContent>
                                <Grid container direction='column' style={{textAlign: "center"}}>
                                    ...
                                    <Grid item>
                                        <Typography variant="subtitle1">
                                            Visionary insights coupled with cutting-edge technology is a receipe for
                                            revolution.
                                        </Typography>
                        ...
                        <Grid item container style={{textAlign: matchesXS ? "center" : "inherit"}} direction= {matchesXS ? "column" : "row"}>
                            <Grid sm item style={{marginLeft:matchesXS ? 0 : matchesSM ? "2em" : "5em"}}>
                                <Grid container style={{marginBottom: matchesXS ? "10em" : 0}} direction='column'>
                                    ...
                                    <Grid item>
                                        <Button component={Link} to="/about" onClick={() => setValue(3)} variant='outlined' className={classes.learnButton} style={{color:"white", borderColor:"white"}}>
                                        <span style={{marginRight:10}}>Learn More</span>
                            ...
                            <Grid sm item style={{ marginRight: matchesXS ? 0 : matchesSM ? "2em" : "5em", textAlign:matchesXS ? "center" : "right"}} >
                                <Grid container direction='column'>
                                    ...
                                    <Grid item>
                                        <Button component={Link} to="/contact" variant='outlined' onClick={() => setValue(4)} className={classes.learnButton} style={{color:"white", borderColor:"white"}}>
                                        <span style={{marginRight:10}}>Learn More</span>
                                        <ButtonArrow height={10} width={10} fill="white"/>
                                        </Button>
                                    </Grid>
