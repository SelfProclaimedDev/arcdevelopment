...
export default function CustomSoftware({setValue, setSelectedIndex}){
    ...
    return(
        <Grid container direction="column" >
            ...
            <Grid item container direction="row" justify="center" style={{marginBottom:"20em", marginTop:"15em"}} className={classes.rowContainer}>
                ...
                <Grid item container direction="column" md style={{maxWidth:"40em", marginTop:matchesSM ? "5em" : 0,marginBottom:matchesMD ? "5em" : 0}} alignItems="center">
                    <Grid item>
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} style={{marginBottom: "10em"}} alignItems={matchesMD ? "center" : undefined} justify="space-between" className={classes.rowContainer}>
                <Grid item container className={classes.itemContainer} md style={{marginBottom: matchesMD ? "15em" : 0}} direction={matchesSM ? "column" : "row"} >
                    <Grid item container direction="column" md>
                        <Grid item>
                            <Typography variant="h4" align={matchesSM ? "center" : undefined}>Digital documents and Data</Typography>
                        </Grid>
                        <Grid item>
            ...
            <Grid item container direction="row" className={classes.rowContainer}>
                <Grid item container direction="column" alignItems="center">
                    <Grid item>
                        <img src={roots} alt="trees with roots extending out" height={matchesSM ?"450em":"300em"} width={matchesSM ?"300em":"450em"} />
                    </Grid>
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} alignItems={matchesMD ? "center" : undefined} justify="space-between" style={{marginTop:"20em", marginBottom:"20em"}} className={classes.rowContainer}>
                <Grid item container className={classes.itemContainer} md style={{marginBottom: matchesMD ? "15em" : 0}} direction={matchesSM ? "column" : "row"}>
                ...
                <Grid item container className={classes.itemContainer} md direction={matchesSM ? "column" : "row"}>
                    ...
                    <Grid item container direction="column" md>
                        <Grid item>
                            <Typography variant="h4" align={matchesSM ? "center" : "right"}>User Experience</Typography>
                        </Grid>
                        <Grid item>
                            <Typography variant="body1" paragraph align={matchesSM ? "center" : "right"} >
